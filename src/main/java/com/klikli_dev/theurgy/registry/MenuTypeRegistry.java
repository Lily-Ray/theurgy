...
import com.klikli_dev.theurgy.content.item.guidemo.GuiDemoMenu;
...
public class MenuTypeRegistry {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<GuiDemoMenu>> GUI_DEMO = MENU_TYPES.register("gui_demo", () -> IMenuTypeExtension.create(GuiDemoMenu::create));
